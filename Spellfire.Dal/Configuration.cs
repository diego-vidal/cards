    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SpellfireContext>
    {
        ...
        private void SeedBoosterLookup(SpellfireContext context)
        {
            context.Boosters.AddOrUpdate(
                x => x.BoosterKey,
                    new Booster { BoosterKey = BoosterKey.NoEdition, ShortName = BoosterKey.NoEdition.GetDisplayShortName(), Name = BoosterKey.NoEdition.GetDisplayName(), SortOrder = 1 },
                    new Booster { BoosterKey = BoosterKey.FirstEdition, ShortName = BoosterKey.FirstEdition.GetDisplayShortName(), Name = BoosterKey.FirstEdition.GetDisplayName(), SortOrder = 2 },
                    new Booster { BoosterKey = BoosterKey.SecondEdition, ShortName = BoosterKey.SecondEdition.GetDisplayShortName(), Name = BoosterKey.SecondEdition.GetDisplayName(), SortOrder = 4 },
                    new Booster { BoosterKey = BoosterKey.ThirdEdition, ShortName = BoosterKey.ThirdEdition.GetDisplayShortName(), Name = BoosterKey.ThirdEdition.GetDisplayName(), SortOrder = 9 },
                    new Booster { BoosterKey = BoosterKey.FourthEdition, ShortName = BoosterKey.FourthEdition.GetDisplayShortName(), Name = BoosterKey.FourthEdition.GetDisplayName(), SortOrder = 13 },
                    new Booster { BoosterKey = BoosterKey.Promo, ShortName = BoosterKey.Promo.GetDisplayShortName(), Name = BoosterKey.Promo.GetDisplayName(), SortOrder = 0 },
                    new Booster { BoosterKey = BoosterKey.Ravenloft, ShortName = BoosterKey.Ravenloft.GetDisplayShortName(), Name = BoosterKey.Ravenloft.GetDisplayName(), SortOrder = 2 },
                    new Booster { BoosterKey = BoosterKey.DragonLance, ShortName = BoosterKey.DragonLance.GetDisplayShortName(), Name = BoosterKey.DragonLance.GetDisplayName(), SortOrder = 5 },
                    new Booster { BoosterKey = BoosterKey.ForgottenRealms, ShortName = BoosterKey.ForgottenRealms.GetDisplayShortName(), Name = BoosterKey.ForgottenRealms.GetDisplayName(), SortOrder = 6 },
                    new Booster { BoosterKey = BoosterKey.Artifacts, ShortName = BoosterKey.Artifacts.GetDisplayShortName(), Name = BoosterKey.Artifacts.GetDisplayName(), SortOrder = 7 },
                    new Booster { BoosterKey = BoosterKey.Powers, ShortName = BoosterKey.Powers.GetDisplayShortName(), Name = BoosterKey.Powers.GetDisplayName(), SortOrder = 8 },
                    new Booster { BoosterKey = BoosterKey.TheUnderdark, ShortName = BoosterKey.TheUnderdark.GetDisplayShortName(), Name = BoosterKey.TheUnderdark.GetDisplayName(), SortOrder = 10 },
                    new Booster { BoosterKey = BoosterKey.RunesAndRuins, ShortName = BoosterKey.RunesAndRuins.GetDisplayShortName(), Name = BoosterKey.RunesAndRuins.GetDisplayName(), SortOrder = 11 },
                    new Booster { BoosterKey = BoosterKey.Birthright, ShortName = BoosterKey.Birthright.GetDisplayShortName(), Name = BoosterKey.Birthright.GetDisplayName(), SortOrder = 12 },
                    new Booster { BoosterKey = BoosterKey.Draconomicon, ShortName = BoosterKey.Draconomicon.GetDisplayShortName(), Name = BoosterKey.Draconomicon.GetDisplayName(), SortOrder = 14 },
                    new Booster { BoosterKey = BoosterKey.NightStalkers, ShortName = BoosterKey.NightStalkers.GetDisplayShortName(), Name = BoosterKey.NightStalkers.GetDisplayName(), SortOrder = 15 },
                    new Booster { BoosterKey = BoosterKey.Dungeons, ShortName = BoosterKey.Dungeons.GetDisplayShortName(), Name = BoosterKey.Dungeons.GetDisplayName(), SortOrder = 16 },
                    new Booster { BoosterKey = BoosterKey.Inquisition, ShortName = BoosterKey.Inquisition.GetDisplayShortName(), Name = BoosterKey.Inquisition.GetDisplayName(), SortOrder = 17 },
                    new Booster { BoosterKey = BoosterKey.Millennium, ShortName = BoosterKey.Millennium.GetDisplayShortName(), Name = BoosterKey.Millennium.GetDisplayName(), SortOrder = 18 },
                    new Booster { BoosterKey = BoosterKey.Chaos, ShortName = BoosterKey.Chaos.GetDisplayShortName(), Name = BoosterKey.Chaos.GetDisplayName(), SortOrder = 19 },
                    new Booster { BoosterKey = BoosterKey.Conquest, ShortName = BoosterKey.Conquest.GetDisplayShortName(), Name = BoosterKey.Conquest.GetDisplayName(), SortOrder = 20 }
                );
        }
        ...
        private void SeedTypeLookup(SpellfireContext context)
        {
            context.Kinds.AddOrUpdate(
                x => x.KindKey,
                    new Kind { KindKey = KindKey.None, IconPath = KindKey.None.GetDisplayDescription(), Name = KindKey.None.GetDisplayName() },
                    new Kind { KindKey = KindKey.Ally, IconPath = KindKey.Ally.GetDisplayDescription(), Name = KindKey.Ally.GetDisplayName() },
                    new Kind { KindKey = KindKey.Artifact, IconPath = KindKey.Artifact.GetDisplayDescription(), Name = KindKey.Artifact.GetDisplayName() },
                    new Kind { KindKey = KindKey.BloodAbility, IconPath = KindKey.BloodAbility.GetDisplayDescription(), Name = KindKey.BloodAbility.GetDisplayName() },
                    new Kind { KindKey = KindKey.ClericSpell, IconPath = KindKey.ClericSpell.GetDisplayDescription(), Name = KindKey.ClericSpell.GetDisplayName() },
                    new Kind { KindKey = KindKey.Cleric, IconPath = KindKey.Cleric.GetDisplayDescription(), Name = KindKey.Cleric.GetDisplayName() },
                    new Kind { KindKey = KindKey.Event, IconPath = KindKey.Event.GetDisplayDescription(), Name = KindKey.Event.GetDisplayName() },
                    new Kind { KindKey = KindKey.Hero, IconPath = KindKey.Hero.GetDisplayDescription(), Name = KindKey.Hero.GetDisplayName() },
                    new Kind { KindKey = KindKey.Holding, IconPath = KindKey.Holding.GetDisplayDescription(), Name = KindKey.Holding.GetDisplayName() },
                    new Kind { KindKey = KindKey.MagicalItem, IconPath = KindKey.MagicalItem.GetDisplayDescription(), Name = KindKey.MagicalItem.GetDisplayName() },
                    new Kind { KindKey = KindKey.Monster, IconPath = KindKey.Monster.GetDisplayDescription(), Name = KindKey.Monster.GetDisplayName() },
                    new Kind { KindKey = KindKey.PsionicPower, IconPath = KindKey.PsionicPower.GetDisplayDescription(), Name = KindKey.PsionicPower.GetDisplayName() },
                    new Kind { KindKey = KindKey.Psionicist, IconPath = KindKey.Psionicist.GetDisplayDescription(), Name = KindKey.Psionicist.GetDisplayName() },
                    new Kind { KindKey = KindKey.Realm, IconPath = KindKey.Realm.GetDisplayDescription(), Name = KindKey.Realm.GetDisplayName() },
                    new Kind { KindKey = KindKey.Regent, IconPath = KindKey.Regent.GetDisplayDescription(), Name = KindKey.Regent.GetDisplayName() },
                    new Kind { KindKey = KindKey.Rule, IconPath = KindKey.Rule.GetDisplayDescription(), Name = KindKey.Rule.GetDisplayName() },
                    new Kind { KindKey = KindKey.Thief, IconPath = KindKey.Thief.GetDisplayDescription(), Name = KindKey.Thief.GetDisplayName() },
                    new Kind { KindKey = KindKey.ThiefSkill, IconPath = KindKey.ThiefSkill.GetDisplayDescription(), Name = KindKey.ThiefSkill.GetDisplayName() },
                    new Kind { KindKey = KindKey.UnarmedCombat, IconPath = KindKey.UnarmedCombat.GetDisplayDescription(), Name = KindKey.UnarmedCombat.GetDisplayName() },
                    new Kind { KindKey = KindKey.WizardSpell, IconPath = KindKey.WizardSpell.GetDisplayDescription(), Name = KindKey.WizardSpell.GetDisplayName() },
                    new Kind { KindKey = KindKey.Wizard, IconPath = KindKey.Wizard.GetDisplayDescription(), Name = KindKey.Wizard.GetDisplayName() },
                    new Kind { KindKey = KindKey.Dungeon, IconPath = KindKey.Dungeon.GetDisplayDescription(), Name = KindKey.Dungeon.GetDisplayName() }
                 );
        }
